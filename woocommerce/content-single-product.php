...
foreach ($quick_stats_config as $attr_key => $config) {
    if (! isset($attributes[$attr_key])) continue;
    ...
    <div class="wf-container">
        ...
        <div class="devhub-single__layout">
            ...
            <div class="devhub-single__info">
                ...
                <div class="devhub-single__price-row">
                    ...
                    <span class="devhub-single__stock devhub-single__stock--<?php echo $product->is_in_stock() ? 'in' : 'out'; ?>">
                ...
                <div class="devhub-single__option-group">
                    ...
                    <div class="devhub-single__color-swatches" role="group" aria-label="<?php esc_attr_e('Color options', 'devicehub-theme'); ?>">
                        <?php foreach ($colors as $color) : ?>
                        <button class="devhub-single__color-swatch"
                                type="button"
                ...
                <div class="devhub-single__option-group">
                    <p class="devhub-single__option-label"><?php esc_html_e('Choose your storage', 'devicehub-theme'); ?></p>
                    <div class="devhub-single__storage-options" role="group" aria-label="<?php esc_attr_e('Storage options', 'devicehub-theme'); ?>">
                        <?php foreach ($storages as $storage) : ?>
                        <button class="devhub-single__storage-btn"
                                type="button"
                    ...
                    <div class="devhub-single__bundles-slider">
                        <div class="devhub-single__bundles-viewport">
                            <div class="devhub-single__bundles-track" id="devhubBundlesTrack">
                                ...
                                <div class="devhub-single__bundle-card<?php echo $idx === 0 ? ' devhub-single__bundle-card--active' : ''; ?>">
                                    ...
                                    <div class="devhub-single__bundle-meta">
                                        <div class="devhub-single__bundle-row">
                                            <span class="devhub-single__bundle-meta-key"><?php esc_html_e('Internet data', 'devicehub-theme'); ?></span>
                                            <span class="devhub-single__bundle-meta-val"><?php echo esc_html($bundle['data']); ?></span>
                                        </div>
                                        <div class="devhub-single__bundle-row">
                                            <span class="devhub-single__bundle-meta-key"><?php esc_html_e('Voice', 'devicehub-theme'); ?></span>
                                            <span class="devhub-single__bundle-meta-val"><?php echo esc_html($bundle['voice']); ?></span>
                                        </div>
                                    </div>
                                    <div class="devhub-single__bundle-footer">
                                        <div class="devhub-single__bundle-plan">
                                            <p class="devhub-single__bundle-plan-label"><?php esc_html_e('Monthly Plan', 'devicehub-theme'); ?></p>
                                            <p class="devhub-single__bundle-price"><?php echo esc_html($bundle['price']); ?></p>
                                        </div>
                                        <a href="<?php echo esc_url($bundle['url']); ?>" class="devhub-single__bundle-link">
                        ...
                        <button class="devhub-single__bundle-arrow devhub-single__bundle-arrow--next" id="devhubBundleNext"
                                type="button"
                ...
                <form class="devhub-single__cart-form cart" method="post" enctype="multipart/form-data"
                    ...
                    <input type="hidden"
                           name="<?php echo esc_attr('attribute_' . sanitize_title($attr_name)); ?>"
                           id="devhubAttr_<?php echo esc_attr(sanitize_title($attr_name)); ?>"
                           value="">
                    <?php endforeach; ?>
                    <?php endif; ?>
                    ...
                    <div class="devhub-single__actions">
                        ...
                        <button type="button"
                                class="devhub-single__btn devhub-single__btn--buy">
        ...
        <div class="devhub-single__tabs">
            ...
            <div class="devhub-single__tab-nav" role="tablist">
                <button class="devhub-single__tab-btn"
                        role="tab"
                        aria-selected="false"
                        aria-controls="devhubTabFeatures"
                        data-tab="features">
                    <?php esc_html_e('Features', 'devicehub-theme'); ?>
                </button>
                <button class="devhub-single__tab-btn devhub-single__tab-btn--active"
                        role="tab"
                        aria-selected="true"
                        aria-controls="devhubTabSpecs"
                        data-tab="specs">
