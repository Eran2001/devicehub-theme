			...
			<section class="devhub-auth__panel<?php echo $is_active_panel( 'chooser' ) ? ' is-active' : ''; ?>" data-devhub-panel="chooser" aria-labelledby="devhub-auth-chooser-title"<?php echo $is_active_panel( 'chooser' ) ? '' : ' hidden'; ?>>
				...
				<div class="devhub-auth__options">
					<button type="button" class="devhub-auth__option" data-devhub-placeholder
						data-devhub-message="<?php esc_attr_e( 'Google sign-in will be connected later. Use email login for now.', 'devicehub-theme' ); ?>">
					...
					<button type="button" class="devhub-auth__option" data-devhub-placeholder
						data-devhub-message="<?php esc_attr_e( 'Facebook sign-in will be connected later. Use email login for now.', 'devicehub-theme' ); ?>">
