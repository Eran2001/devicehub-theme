		...
		<div class="devhub-auth__card">
			...
			<section class="devhub-auth__panel" data-devhub-panel="chooser" aria-labelledby="devhub-auth-chooser-title">
				...
				<div class="devhub-auth__options">
					<button type="button" class="devhub-auth__option" data-devhub-placeholder
						data-devhub-message="<?php esc_attr_e('Google sign-in will be connected later. Use Guest User for the existing login flow right now.', 'devicehub-theme'); ?>">
					...
					<button type="button" class="devhub-auth__option" data-devhub-placeholder
						data-devhub-message="<?php esc_attr_e('Facebook sign-in will be connected later. Use Guest User for the existing login flow right now.', 'devicehub-theme'); ?>">
					...
					<button type="button" class="devhub-auth__option" data-devhub-placeholder
						data-devhub-message="<?php esc_attr_e('Mobile OTP login UI will be wired later. Use Guest User for the current login flow.', 'devicehub-theme'); ?>">
					...
					<button type="button" class="devhub-auth__option" data-devhub-placeholder
						data-devhub-message="<?php esc_attr_e('Email OTP login UI will be wired later. Use Guest User for the current login flow.', 'devicehub-theme'); ?>">
						<img class="devhub-auth__option-icon" src="<?php echo esc_url($auth_icons['mail']); ?>" alt=""
							aria-hidden="true" />
						<span><?php esc_html_e('Sign up with Email', 'devicehub-theme'); ?></span>
					</button>
				</div>
				...
				<button type="button" class="devhub-auth__option devhub-auth__option--ghost"
					...
					<span><?php esc_html_e('Guest User', 'devicehub-theme'); ?></span>
				</button>
			...
			<section class="devhub-auth__panel" data-devhub-panel="guest" aria-labelledby="devhub-auth-login-title">
				...
				<p class="devhub-auth__subtitle">
					<?php esc_html_e('Use your username or email address and password to log in.', 'devicehub-theme'); ?>
				</p>
